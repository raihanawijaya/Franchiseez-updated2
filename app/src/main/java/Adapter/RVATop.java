...
public class RVATop extends RecyclerView.Adapter<RVATop.ViewHolder> {

    public Context mcontex;
    public List<data_card_saran> listdata;

    public RVATop(Context mcontex, List<data_card_saran> listdata) {
